...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_9 = Integer(9); _sage_const_8 = Integer(8); _sage_const_295 = Integer(295); _sage_const_200 = Integer(200); _sage_const_22 = Integer(22); _sage_const_23 = Integer(23); _sage_const_20 = Integer(20); _sage_const_21 = Integer(21); _sage_const_26 = Integer(26); _sage_const_24 = Integer(24); _sage_const_25 = Integer(25); _sage_const_136 = Integer(136); _sage_const_62 = Integer(62); _sage_const_290 = Integer(290); _sage_const_80 = Integer(80); _sage_const_138 = Integer(138); _sage_const_68 = Integer(68); _sage_const_297 = Integer(297); _sage_const_202 = Integer(202); _sage_const_315 = Integer(315); _sage_const_209 = Integer(209); _sage_const_313 = Integer(313); _sage_const_211 = Integer(211); _sage_const_195 = Integer(195); _sage_const_217 = Integer(217); _sage_const_13 = Integer(13); _sage_const_88 = Integer(88); _sage_const_11 = Integer(11); _sage_const_10 = Integer(10); _sage_const_17 = Integer(17); _sage_const_16 = Integer(16); _sage_const_15 = Integer(15); _sage_const_14 = Integer(14); _sage_const_30 = Integer(30); _sage_const_19 = Integer(19); _sage_const_18 = Integer(18); _sage_const_127 = Integer(127); _sage_const_121 = Integer(121); _sage_const_70 = Integer(70); _sage_const_12 = Integer(12); _sage_const_129 = Integer(129); _sage_const_78 = Integer(78); _sage_const_143 = Integer(143); _sage_const_306 = Integer(306); _sage_const_304 = Integer(304)## This file (factoringTrinomials.sagetex.sage) was *autogenerated* from factoringTrinomials.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
_st_ = sagetex.SageTeXProcessor('factoringTrinomials', version='2015/08/26 v3.0-92d9f7a', version_check=True)
...
try:
 ...
 def generateFactors(minimumPrime, maximumPrime, numberOfFactors):
     listPrimes = prime_range(minimum, maximum)
     aFactors = [random.sample(listPrimes, _sage_const_1 ) for i in xrange(numberOfFactors)]
     cFactors = [random.sample(listPrimes, _sage_const_1 ) for i in xrange(numberOfFactors)]
