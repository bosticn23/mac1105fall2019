...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_99 = Integer(99); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_5 = Integer(5); _sage_const_4 = Integer(4); _sage_const_254 = Integer(254); _sage_const_260 = Integer(260); _sage_const_9 = Integer(9); _sage_const_262 = Integer(262); _sage_const_287 = Integer(287); _sage_const_1 = Integer(1); _sage_const_269 = Integer(269); _sage_const_280 = Integer(280); _sage_const_278 = Integer(278); _sage_const_8 = Integer(8)## This file (determineHorizontalAsymptotes.sagetex.sage) was *autogenerated* from determineHorizontalAsymptotes.tex with sagetex.sty version 2015/08/26 v3.0-92d9f7a.
import sagetex
